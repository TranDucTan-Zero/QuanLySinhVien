...
<head>
    ...
    <style>
        ...
        /* Định dạng của hộp chứa đăng ký */
        .container {
            width: 350px;
            padding: 20px;
        ...
        /* Hiển thị màu sắc khác khi đưa chuột vào liên kết (Đăng nhập) */
        .container a:hover {
            color: red;
        }

        /* Định dạng các thông báo hoặc dòng chữ không chính thức (Như "Đã có tài khoản?") */
        .container p {
            color: #606060;
        }
    </style>
...
<body>
    ...
    <div class="container">
        ...
        <form action="/register" method="post">
            <!-- Ô nhập Tên người dùng với placeholder là "Tên truy cập" -->
            <input type="text" name="username" placeholder="Tên truy cập" required><br>
            <!-- Ô nhập Mật khẩu với placeholder là "Nhập mật khẩu" -->
